...
public class DefaultCsvReaderConfig {
    /** 默认字符集，解析中是不需要的，在 DefaultCsvReader 中的部分 from 方法需要 */
    public static Charset CHARSET = Charset.forName("utf-8");

    /** 从文件读取数据的 buffer 大小：缓冲区大小可以提高性能 */
    public static int READE_BUFFER_SIZE = 4096;
     ...
     * </pre>
     */
    public static int COLUMN_BUFFER_SIZE = 4096;

    /** 使用 MappedCsvReader 的时候 MappedByteBuffer 的初始默认值 */
    public static int MAPPED_SIZE = Integer.MAX_VALUE;

    /** 列分割符 */
    public static byte DELIMITER = Letters.COMMA;
